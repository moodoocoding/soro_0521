...
- **고급 픽셀아트 에디터 UI/UX 전면 개편 완료 (2026-05-26)**:
  - 10가지 개선안(SVG 아이콘 교체, 패널 디자인, 하단 바 분리, 캔버스 비율 등)을 모두 반영하여 프리미엄 수준의 어두운 테마(Dark Theme) UI로 리디자인 완료.
  - 마우스 커서, 액션 버튼의 시각적 분리 등을 통해 사용자 경험(UX) 극대화.
